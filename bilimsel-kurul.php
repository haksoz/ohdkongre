...
<?php $page = 'kurullar'; ?>
<head>
    <title>1. Uluslararası Onkoloji Hemşireliği Derneği Kongresi | Bilimsel Kurul</title>
            ...
            <div class="container">
                ...
                <div class="text-center col-md-6">
                    <p>
                        ...
                        Uzm. Dr. Eran BEN AYRE<br>
                        Dr. Jeannine M. BRANT<br>
                        Dr. Manal AL-ZADİALİ
                    </p>
                </div>
                <div class="col-md-12">
                    <p class="text-center"><span class="text-red">* İsimler alfabetik sıraya göre dizilmiştir.</span></p>
                </div>
            </div>
            </div>
        </section><!-- /section  -->
