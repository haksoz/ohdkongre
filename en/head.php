	...
	<!--[if lt IE 9]>
      ...
      <![endif]-->
	<!-- Bootstrap Core CSS -->
	<link href="/css/bootstrap.css?v=561654123123423" rel="stylesheet" type="text/css"><!-- Icon fonts -->
	<link href="/fonts/font-awesome/css/font-awesome.min.css?v=561654123123423" rel="stylesheet" type="text/css">
	<link href="/fonts/glyphicons/bootstrap-glyphicons.css?v=561654123123423" rel="stylesheet" type="text/css">
	<link href="/fonts/flaticons/flaticon.css?v=561654123123423" rel="stylesheet" type="text/css"><!-- Google fonts -->
...
<link href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
	...
	<link href="/css/style.css?v=561654123123423" rel="stylesheet"><!-- Plugins CSS -->
	<link href="/css/plugins.css?v=561654123123423" rel="stylesheet"><!-- Color Style CSS -->
	<link href="/styles/pinkandblue.css?v=561654123123423" rel="stylesheet"><!-- LayerSlider stylesheet -->
	<link href="/layerslider/css/layerslider.css?v=561654123123423" rel="stylesheet"><!-- Favicons-->
