...
function startCountdown(targetDate, daysId, hoursId, minutesId, secondsId) {
  var countdownFunction = setInterval(function () {
      ...
      document.getElementById(daysId).innerHTML = days + " <span>Day</span>";
      document.getElementById(hoursId).innerHTML = hours + " <span>Hour</span>";
      document.getElementById(minutesId).innerHTML = minutes + " <span>Minute</span>";
      document.getElementById(secondsId).innerHTML = seconds + " <span>Second</span>";
