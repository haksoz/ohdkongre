    ...
    <div id="page-section">
        ...
        <section class="container" id="services">
            <div class="section-heading">
                <h2 class="mt-5">GENEL BİLGİLER</h2>
                <div class="hr"></div>
            </div>
            <div class="col-md-12 col-md-12 res-margin">
                ...
                <p>
                    <b class="text-uppercase fs-18 mr-2">Toplanı Yeri ve Tarihi: </b> <br>
                ...
                <p>
                    <b class="text-uppercase fs-18 mr-2">Toplantı Dili: </b><br>
                    Kongrenin resmi dili Türkçe’dir.
                </p>
                <p>
                    <b class="text-uppercase fs-18 mr-2">Kayıt ve Danışma Masaları: </b><br>
                ...
                <p>
                    <b class="text-uppercase fs-18 mr-2">Yaka Kartı: </b><br>
