                ...
                <div class="row">
                    <div class="col-lg-12 m-auto">
                        <div class="heading2 text-center space-margin60">
                            ...
                            <h5 style="margin-top: 20px;text-transform: none;color:#ed1c25;text-align: center;">7 Mayıs tarihinde Kurslar Bilgi Üniversitesi Dolapdere Kampüsü'nde düzenlenecektir.</h5>
                        </div>
                    </div>
                    <div class="col-lg-12 m-auto">
                        <div class="heading2 text-center space-margin60">
